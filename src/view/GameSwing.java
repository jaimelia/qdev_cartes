...
public class GameSwing implements GameViewable {
	...
	// when clicked, tell controller to add a new view and set its controller
	private void addAddGameViewButton(Container contentPane) {
		btnAddGameView = new JButton("Add View");
		addCenteredComponent(btnAddGameView, contentPane);
		btnAddGameView.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				textArea.append("Cards dealt:\n");
				GameSwing newView = new GameSwing();
	...
	@Override
	public void showCardForPlayer(int playerIndex, String name, String cardRank, String cardSuit) {
		appendText("[" + name + "][" + cardRank + ":" + cardSuit + "]");
	}
